...
def run_investigation_pipeline(custom_events: List[Dict[str, Any]] = None) -> InvestigationResponse:
    ...
    # 7. Summary Narrative Generation
    summary = InvestigationSummary(
        totalCorrelatedEvents=2214 if not custom_events else len(normalized_events),
    ...
    return InvestigationResponse(
        ...
        silosLoadedCount=4,
        totalRawEvents=2214 if not custom_events else len(normalized_events),
        coverageScore=78,
